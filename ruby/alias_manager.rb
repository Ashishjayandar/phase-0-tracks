...
#method defined
def name_scrambler(str1,str2)
  name_to_scramble=[]
  name_to_scramble=[str1,str2]
  index=name_to_scramble.length
  id=0
  ...
  name_to_scramble=name_to_scramble.reverse
  name_to_scramble=name_to_scramble.join(" ")			#the new scrambled name made
  #return arr
end
...
register[full_name]= scrambled_name
